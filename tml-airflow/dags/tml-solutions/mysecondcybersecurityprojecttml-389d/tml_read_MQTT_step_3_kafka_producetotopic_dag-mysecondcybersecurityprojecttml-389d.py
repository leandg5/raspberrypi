...
default_args = {
  ...
  'mqtt_broker' : '231ee40abdba4295a8d29eba3b9b7f01.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_mysecondcybersecurityprojecttml-389d", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_mysecondcybersecurityprojecttml-389d"], schedule=None,catchup=False)
